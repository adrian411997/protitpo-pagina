            ...
            <div className="element fifth">
              <button className="not-button">
                <svg width="50px" height="50px" viewBox="0 0 64 64" fill="none">
                  <path
                    d="M51.195 22.646H36.174V7.625L51.195 22.646Z"
                    stroke="#426AB2"
                    stroke-width="4"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M51.196 22.646V51.709C51.196 52.7699 50.7746 53.7873 50.0244 54.5374C49.2743 55.2876 48.2569 55.709 47.196 55.709H16.138C15.0771 55.709 14.0597 55.2876 13.3096 54.5374C12.5594 53.7873 12.138 52.7699 12.138 51.709V11.625C12.138 10.5641 12.5594 9.54672 13.3096 8.79657C14.0597 8.04642 15.0771 7.625 16.138 7.625H36.174L51.196 22.646Z"
                    stroke="#000000"
                    stroke-width="4"
                    stroke-linecap="round"
                    stroke-linejoin="round"
